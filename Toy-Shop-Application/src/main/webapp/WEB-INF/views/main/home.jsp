...
<section class="product py-lg-4 py-md-3 py-sm-3 py-3">
	<div class="container py-lg-5 py-md-5 py-sm-4 py-3">
		...
		<div class=" img-toy-w3l-top"
			style=" background: url(${image}/cc1.jpg)no-repeat center;"></div>
		...
		<div class="row">
			<div class="col-lg-6 img-toy-w3l-left">
				<div class="toys-img-one"
					style="background: url(${image}/cc2.jpg)no-repeat center;"></div>
				<div class="mt-lg-4 mt-3 product-info-img">
					<p>velit sagittis vehicula. Duis posuere ex in mollis iaculis.
						Suspendisse tincidunt velit sagittis vehicula. Duis posuere velit
						sagittis vehicula. Duis posuere</p>
			...
			<div class="col-lg-6 img-toy-agile-right">
				<div class="toys-img-one-two"
					style="background: url(${image}/tt1.jpg)no-repeat center;"></div>
				<div class="mt-lg-4 mt-3 product-info-img">
					<p>velit sagittis vehicula. Duis posuere ex in mollis iaculis.
						Suspendisse tincidunt velit sagittis vehicula. Duis posuere velit
						sagittis vehicula. Duis posuere</p>
				...
				<div class="toys-img-one-three"
					style="background: url(${image}/tt2.jpg)no-repeat center;"></div>
				<div class="mt-lg-4 mt-3 product-info-img">
					<p>velit sagittis vehicula. Duis posuere ex in mollis iaculis.
						Suspendisse tincidunt velit sagittis vehicula. Duis posuere velit
						sagittis vehicula. Duis posuere</p>
...
<section class="premium py-lg-4 py-md-3 py-sm-3 py-3">
	<div class="container py-lg-5 py-md-5 py-sm-4 py-3">
		<h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Premium
			Toys</h3>
		<div class="row">
			<div class="col-lg-6 agileits-toys-left"
				style="background: url(${image}/pp1.png)no-repeat center; background-size: cover;"></div>
